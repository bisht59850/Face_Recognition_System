...
class Attendance:
    def __init__(self,root):
        ...
        # 1
        img=Image.open(r"E:\Python_projects\facial_recognition\images\castle.jpg")  #yha se 22:16 7/9
        img = img.resize((800, 2000),Image.Resampling.LANCZOS)
        ...
        img3 = img3.resize((1547, 710),Image.Resampling.LANCZOS)
        self.photoimg3=ImageTk.PhotoImage(img3)

        bg_img=Label(self.root,image=self.photoimg3)
        bg_img.place(x=0,y=200,width=1547,height=710)

        title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="white",fg="darkgreen")
        title_lbl.place(x=0,y=0,width=1547,height=45)
        ...
        attendanceId_label.grid(row=0,column=0,padx=4,pady=5,sticky=W)
        ...
        # Name
        nameabel=Label(left_inside_frame,text="Name:",font=("times new roman",12,"bold"),bg="white")
        nameabel.grid(row=1,column=0,padx=4,pady=8,sticky=W)
